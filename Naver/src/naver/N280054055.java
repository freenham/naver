...
public class N280054055 {
    ...
    public static void main(String[] args) {
        ...
        // 시간 출력
        System.out.println("##  시작시간 : " + new N280054055().formatTime(startTime));
        System.out.println("##  종료시간 : " + new N280054055().formatTime(endTime));
        System.out.println("##  소요시간 : " + new N280054055().formatTime(endTime - startTime));
